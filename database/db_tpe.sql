...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2022 a las 00:57:40
...
(107, 'update', 69, '#2e49b8', 'm', 'update description ', 4),
...
(120, 'updateultimo', 69, '#2e49b8', 'm', 'update description ', 4),
...
(131, 'tesst nuevo', 89, '#cb159b', 's', 'dw', 2);
...
--
ALTER TABLE `products`
  MODIFY `id_products` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
